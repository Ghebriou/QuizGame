 ...
 public class QuizCapital extends JFrame implements ActionListener {
     ...
     QuizCapital(String name, boolean isDifficult) {
         this.name = name;
         ...
         ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("imgs/capitals.png"));
         JLabel image = new JLabel(i1);
         image.setBounds(740,-40, 400,600);
         add(image);
         ...
         if (isDifficult) {
             ...
             questions[0] = new String[]{"What is the capital of Ireland", "Dublin", "Galway", "Cork", "Waterford"};
             answers[0] = new String[]{"Dublin", "Dublin"};

             questions[1] = new String[]{"What is the capital of Austria?", "Bucarest", "Budapest", "Vienna", "Sofia"};
             answers[1] = new String[]{"Vienna", "Vienna"};

             questions[2] = new String[]{"What is the capital of Greece?", "Mykonos", "Athens", "Santorini", "Patras"};
             answers[2] = new String[]{"Athens", "Athens"};

             questions[3] = new String[]{"What is the capital of Portugal", "Lisbon", "Porto", "Aveiro", "Evira"};
             answers[3] = new String[]{"Lisbon", "Lisbon"};

             questions[4] = new String[]{"What is the capital of South Korea?", "Busan", "Seoul", "Incheon", "Daegu"};
             answers[4] = new String[]{"Seoul", "Seoul"};

             questions[5] = new String[]{"What is the capital of China?", "Beijing", "Shanghai", "Guangzhou", "Shenzhen"};
             answers[5] = new String[]{"Beijing", "Beijing"};
             
             questions[6] = new String[]{"What is the capital of Russia?", "Yekaterinburg", "St. Petersburg", "Novosibirsk", "Moscow"};
             answers[6] = new String[]{"Moscow", "Moscow"};

             questions[7] = new String[]{"What is the capital of South Africa?", "Pretoria", "Cape Town", "Johannesburg", "All of them"};
             answers[7] = new String[]{"All of them", "All of them"};

             questions[8] = new String[]{"What is the capital of Argentina?", "Rosario", "Cordoba", "Buenos Aires", "Mendoza"};
             answers[8] = new String[]{"Buenos Aires", "Buenos Aires"};

             questions[9] = new String[]{"What is the capital of Saudi Arabia?", "Riyadh", "Jeddah", "Mecca", "Medina"};
             answers[9] = new String[]{"Riyadh", "Riyadh"};
             ...
             answers[3] = new String[]{"Berlin", "Berlin"};

             questions[4] = new String[]{"What is the capital of United Kingdom?", "Dublin", "Manchester", "Edinburgh", "London"};
             answers[4] = new String[]{"London", "London"};
             ...
             answers[9] = new String[]{"Algiers", "Algiers"};
         }
